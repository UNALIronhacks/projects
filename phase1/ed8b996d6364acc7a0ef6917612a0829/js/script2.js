...
function initMap() {
    ...
    var url = "https://data.cityofnewyork.us/api/views/ikqj-pyhc/rows.json?accessType=DOWNLOAD";
...

                {
                    ...
                    $.each(results, function(key, value) {
                        ...
                        markers[key] = new google.maps.Marker({
                            position: {lat: Number(positionalRequest.locations[key].lat()), lng: Number(positionalRequest.locations[key].lng())},
                            map: map
                        ...
                        google.maps.event.addListener(markers[key], 'click', function() {
                            ...
                            */
                            ...
                            var d = [
                                [
                                    {axis:"crime rates",value:array[0]},
                                    {axis:"distance",value:array[1]},
                                    {axis:"proximity to parks",value:array[2]},
                                    {axis:"sport facilities",value:array[3]},
                                    {axis:"transportation",value:array[4]},
                                    {axis:"weather",value:array[5]},
                                    {axis:"criminal/offender",value:array[6]},
